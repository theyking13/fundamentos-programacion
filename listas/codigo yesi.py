...
# if estacionamiento[fila-1][espacio-1] == 'D':
#         estacionamiento[fila-1][espacio-1] = 'R'
...
#     precios = [3000 if i < 2 else 1500 for i in range(6)]
# if estacionamiento[fila-1][espacio-1] == 'R':
#         estacionamiento[fila-1][espacio-1] = 'D'
#         ingresos_totales -= precios[fila-1]
...
#  if opcion == '1':
#             fila 
# = int(input("Ingrese el número de fila (1-6): "))
